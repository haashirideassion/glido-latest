...
export const ICONS = {
  ...
  plane:          'solar:plane-bold-duotone',
  ...
  clipboardCheck: 'solar:clipboard-check-bold-duotone',
  siren:          'solar:siren-rounded-bold-duotone',
